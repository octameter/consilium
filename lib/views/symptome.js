...
Symptome.prototype.init = function()
{
	...
	this.buildContent("symptomeContentId");
...
// Customize showView
Symptome.prototype.showViewExt = function()
{
...
{	
	...
	back.setTopLeft();
	back.setNavigation();
	back.addElement( Assets.getIcon("left",32) );
...
{		
	...
	function tapEnde(event) 
	{
		...
		if(self.currentItem == event.currentTarget) 
		{
			...
			self.returnToView.addItem( self.currentItem );
