...
Model.prototype.data = {
		...
		symptome : 
			...
			{ id: 1, title: "Subjektives Befinden", kategorie: "Allgemeinsymptome", farbwert:"rgba(255,55,55,0.6)" },
...
Model.prototype.addPunkt = function( punkt )
{
	...
	this.data.end = Math.max( punkt.x, this.data.end );
};

Model.prototype.getDauer = function()
{
	return parseFloat( this.data.end - this.data.start );
};
