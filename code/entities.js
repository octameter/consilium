...
Entities.prototype.Device = 
[
	 { id: "wBlutdruck", title:"Blutdruck", sub:"Logo", kategorie:"Device", min:50, max:240, zero:0,unit:"mmHg", farbwert:"rgba(255,100,100,0.9)"},
	 { id: "wGewicht", title:"Gewicht", sub:"Logo", kategorie:"Device", min:30, max:200, unit:"Kg", zero:0,farbwert:"rgba(255,204,0,0.9)"},
	 { id: "wTemperatur", title:"Körpertemperatur", sub:"Logo", kategorie:"Device", min:35.0, max:42.0, zero:0,unit:"°C",  farbwert:"rgba(200,100,200,0.9)"},
	 { id: "wSättigung", title:"Sauerstoffsättigung", sub:"Logo", kategorie:"Device", min:90.0, max:100, zero:0,unit:"%", farbwert:"rgba(200,100,200,0.9)"}
];

Entities.prototype.Symptome =
	 [                 
      { id: "10016256", title: "Müdigkeit", kategorie:"Symptom", sub: "Allgemeinsymptome", zero:0, unit:"%", farbwert :"rgba(0,139,139,0.9)",
        grad:[    
  ...
  { id: "10013963", title: "Atemnot", kategorie:"Symptom", sub: "Atemwege", zero:0,unit:"%", farbwert:"rgba(40,210,230,0.9)",
      grad:[      
  ...
  { id: "10013950", title: "Schluckstörung", kategorie:"Symptom", sub: "Hals, Nase, Ohren", zero:0,unit:"%",  farbwert:"rgba(160,200,200,0.9)",
    grad:[ 
  ...
  { id: "10012727", title: "Durchfall", kategorie:"Symptom", sub: "Magen- und Darmsystem", zero:0,unit:"%", farbwert:"rgba(0,206,209,0.9)",
        grad:[    
   ...
   { id: "10050068", title: "Ödeme an Gliedmassen", kategorie:"Symptom", sub: "Ödeme",zero:0,unit:"%", farbwert:"rgba(64,224,208,0.9)",
        grad:[    
      ...
      { id: "10013774", title: "Trockene Augen", kategorie:"Symptom", sub: "Augen",zero:0,unit:"%",  farbwert:"rgba(175,238,238,0.9)",
        grad:[    
    ...
    { id: "10037868", title: "Hautausschlag", kategorie:"Symptom", sub: "Haut und Haare",zero:0, unit:"%",farbwert:"rgba(70,130,180,0.9)",
        grad:[    
    ...
    { id: "10020772", title: "Bluthochdruck", kategorie:"Symptom", sub: "Herz- und Kreislaufsystem",zero:0, unit:"%", farbwert:"rgba(95,158,160,0.9)",
        grad:[    
            ...
            { id: "10016791", title: "Erkältungssymptome", kategorie:"Symptom", sub: "Infekt",zero:0,unit:"%",  farbwert:"rgba(30,144,255,0.9)" ,
        grad:[    
    ...
    { id: "10046593", title: "Harndrang", kategorie:"Symptom", sub: "Niere und Harnblase",zero:0,unit:"%", farbwert:"rgba(0,0,205,0.9)",
        grad:[    
                  { info:"Sehr starke Symptome mit Einschränkung der Selbstversorgung (z.B. selbst Ankleiden und Waschen) ist unmöglich.", max:100, min:81, tipps:"iMeld2"},
    ...
    { id: "10038743", title: "Unruhe", kategorie:"Symptom", sub: "Psyche",zero:0,unit:"%",  farbwert:"rgba(65,105,225,0.9)",
        grad:[    
    ...
    { id: "10017999", title: "Bauchschmerzen", kategorie:"Symptom", sub: "Schmerzen",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
    ...
    { id: "10047700", title: "Erbrechen", kategorie:"Symptom", sub: "Magen- und Darmsystem",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
    ...
    { id: "10054524", title: "Hand-Fuss-Syndrom", kategorie:"Symptom", sub: "Haut und Haare",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
              grad:[    
      ...
      { id: "10028813", title: "Übelkeit", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
      ...
      { id: "10016558", title: "Fieber", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
    ...
    { id: "10047340", title: "Schwindel", kategorie:"Symptom", sub: "Allgemeinsymptome", zero:0, unit:"%",farbwert:"rgba(135,206,235,0.9)",
        grad:[    
                  { info:"Sehr starke nicht auszuhaltende Symptome, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
            ...
            { id: "10033371", title: "Schmerzen", kategorie:"Symptom", sub: "Schmerzen",zero:0, unit:"%", farbwert:"rgba(135,206,235,0.9)",
        grad:[    
            ...
            { id: "10011224", title: "Trockener Reizhusten", kategorie:"Symptom", sub: "Atemwege",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
            ...
            { id: "10036790", title: "Husten mit Auswurf", kategorie:"Symptom", sub: "Atemwege", zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
           ...
           { id: "10015090", title: "Nasenbluten", kategorie:"Symptom", sub: "Blutungen", zero:0,unit:"%",  farbwert:"rgba(70,130,180,0.9)",
        grad:[    
   ...
   { id: "10002646", title: "Appetitverlust", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
   ...
   { id: "10005329", title: "Blutungen", kategorie:"Symptom", sub: "Blutungen",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
   ...
   { id: "10062225", title: "Brennen beim Wasserlassen", kategorie:"Symptom", sub: "Nieren und Harnwege",zero:0, unit:"%", farbwert:"rgba(135,206,235,0.9)",
        grad:[    
                  { info:"Sehr starke nicht auszuhaltende Schmerzen, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
   ...
   { id: "10012378", title: "Depression", kategorie:"Symptom", sub: "Psychische Beschwerden",zero:0, unit:"%", farbwert:"rgba(135,206,235,0.9)",
        grad:[    
    ...
    { id: "10013911", title: "Geschmacksstörung", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0, unit:"%", farbwert:"rgba(135,206,235,0.9)",
        grad:[    
                  { info:"Sehr starke Symptome, deutlicher Gewichtsverlust, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
        ...
        { id: "10047900", title: "Gewichtsverlust", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0, unit:"%", farbwert:"rgba(135,206,235,0.9)",
        grad:[    
        ...
        { id: "10047896", title: "Gewichtszunahme", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0, unit:"%", farbwert:"rgba(135,206,235,0.9)",
        grad:[    
        ...
        { id: "10001760", title: "Haarausfall", kategorie:"Symptom", sub: "Haut und Haare",zero:0, unit:"%",farbwert:"rgba(70,130,180,0.9)",
        grad:[    
        ...
        { id: "10020407", title: "Hitzewallungen", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0,unit:"%", farbwert:"rgba(70,130,180,0.9)",
        grad:[    
                  { info:"Sehr starke Symptome, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
       ...
       { id: "10028130", title: "Mundschleimhaut", kategorie:"Symptom", sub: "Magen- und Darmsystem", zero:0,unit:"%",  farbwert:"rgba(160,200,200,0.9)",
    grad:[ 
        ...
        { id: "10013781", title: "Mundtrockenheit", kategorie:"Symptom", sub: "Magen- und Darmsystem", zero:0,unit:"%",  farbwert:"rgba(160,200,200,0.9)",
    grad:[ 
        ...
        { id: "10043882", title: "Ohrensausen", kategorie:"Symptom", sub: "Hals, Nase, Ohren",zero:0,unit:"%", farbwert:"rgba(70,130,180,0.9)",
        grad:[    
                  { info:"Sehr starke Symptome, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
                  { info:"Starke Symptome, starke Einschränkung im Alltag und Arbeitsunfähigkeit." ,max:80, min:61, tipps:"iMeld2"},
        ...
        { id: "10007810", title: "Katheterbeschwerden", kategorie:"Symptom", sub: "Therapiefolgen",zero:0,unit:"%", farbwert:"rgba(70,130,180,0.9)",
        grad:[    
        ...
        { id: "10022437", title: "Schlafstörung", kategorie:"Symptom", sub: "Psychische Beschwerden",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
        ...
        { id: "10008531", title: "Schüttelfrost", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
        ...
        { id: "10022117", title: "OP-Wunde", kategorie:"Symptom", sub: "Therapiefolgen", zero:0,unit:"%", farbwert:"rgba(70,130,180,0.9)",
        grad:[    
                  { info:"Schwere Symptome, massive Rötung oder Schwellung oder Schmerzen.", max:100, min:61, tipps:"iMeld2"},
                  { info:"Mässige Symptome, deutliche Rötung oder Schwellung oder Schmerzen.", max:60, min:41, tipps:"iMeld2"},
        ...
        { id: "10040102", title: "Serom, Wundwasser", kategorie:"Symptom", sub: "Therapiefolgen", zero:0,unit:"%", farbwert:"rgba(70,130,180,0.9)",
        grad:[    
                  { info:"Schwere Symptome, massive Rötung oder Schwellung oder Schmerzen.", max:100, min:61, tipps:"iMeld2"},
                  { info:"Mässige Symptome, deutliche Rötung oder Schwellung oder Schmerzen.", max:60, min:41, tipps:"iMeld2"},
        ...
        { id: "10008481", title: "Brustschmerz", kategorie:"Symptom", sub: "Allgemeinsymptome",zero:0,unit:"%", farbwert:"rgba(70,130,180,0.9)",
        grad:[    
                  { info:"Sehr starke nicht auszuhaltende Schmerzen, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
                  { info:"Stark anhaltende Schmerzen, stark eingeschränkter Alltag und Arbeitsunfähigkeit." ,max:80, min:61, tipps:"iReserve,iMeld2"},
        ...
        { id: "10046904", title: "Vaginale Trockenheit", kategorie:"Symptom", sub: "Haut und Haare",zero:0,unit:"%", farbwert:"rgba(70,130,180,0.9)",
        grad:[    
        ...
        { id: "10010774", title: "Verstopfung", kategorie:"Symptom", sub: "Magen- und Darmsystem", zero:0,unit:"%", farbwert:"rgba(0,206,209,0.9)",
        grad:[    
        ...
        { id: "10025233", title: "Lymphödem", kategorie:"Symptom", sub: "Ödeme",zero:0,unit:"%", farbwert:"rgba(64,224,208,0.9)",
        grad:[    
                  { info:"Sehr starke Schwellung, starke Bewegungseinschränkung, Selbstversorgung (z.B. Ankleiden und Waschen) ist unmöglich.", max:100, min:81, tipps:"iMeld2"},
        ...
        { id: "10010250", title: "Konzentration eingeschränkt", kategorie:"Symptom", sub: "Nervensystem",zero:0,unit:"%", farbwert:"rgba(64,224,208,0.9)",
        grad:[    
        ...
        { id: "10013573", title: "Benommenheit", kategorie:"Symptom", sub: "Nervensystem",zero:0, unit:"%",farbwert:"rgba(64,224,208,0.9)",
        grad:[    
        ...
        { id: "10019211", title: "Kopfschmerzen", kategorie:"Symptom", sub: "Schmerzen",zero:0, unit:"%", farbwert:"rgba(105,105,135,0.9)",
        grad:[    
                  { info:"Sehr starke nicht auszuhaltende Schmerzen, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
                  { info:"Stark anhaltende Schmerzen, stark eingeschränkter Alltag und Arbeitsunfähigkeit." ,max:80, min:61, tipps:"iReserve,iMeld2"},
        ...
        { id: "10003239", title: "Gelenkschmerzen", kategorie:"Symptom", sub: "Schmerzen",zero:0, unit:"%", farbwert:"rgba(135,206,235,0.9)",
        grad:[    
                  { info:"Sehr starke nicht auszuhaltende Schmerzen, Selbstversorgung (z.B. Ankleiden und Waschen) unmöglich.", max:100, min:81, tipps:"iMeld2"},
                  { info:"Stark anhaltende Schmerzen, stark eingeschränkter Alltag und Arbeitsunfähigkeit." ,max:80, min:61, tipps:"iReserve,iMeld2"},
                  { info:"Mässige und anhaltende Schmerzen, deutliche Einschränkung im Alltag und stark eingeschränkte Arbeitsfähigkeit.", max:60, min:41, tipps:"iReserve,iMeld1"},
        ...
        { id: "10062572", title: "Muskelschwäche", kategorie:"Symptom", sub: "Nervensystem",zero:0, unit:"%",farbwert:"rgba(64,224,208,0.9)",
        grad:[    
         ...
         { id: "10005886", title: "Sehstörung", kategorie:"Symptom", sub: "Augen",zero:0,unit:"%", farbwert:"rgba(64,224,208,0.9)",
        grad:[    
        ...
        { id: "10062872", title: "Empfindungsstörung", kategorie:"Symptom", sub: "Nervensystem",zero:0,unit:"%", farbwert:"rgba(64,224,208,0.9)",
        grad:[    
        ...
        { id: "10003591", title: "Gangstörung", kategorie:"Symptom", sub: "Nervensystem",zero:0,unit:"%", farbwert:"rgba(64,224,208,0.9)",
        grad:[    
         ...
         { id: "10047065", title: "Entzündung der Venen", kategorie:"Symptom", sub: "Blutgefässe",zero:0,unit:"%", farbwert:"rgba(64,224,208,0.9)",
        grad:[    
        ...
        { id: "10034016", title: "Nagelbettentzündung", kategorie:"Symptom", sub: "Haut und Haare",zero:0,unit:"%",  farbwert:"rgba(135,206,235,0.9)",
        grad:[    
