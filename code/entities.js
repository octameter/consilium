...
[
		 ...
		 { id: "oximeter", title:"Sauerstoffsättigung", sub:"Logo", kategorie:"Device", min:90.0, max:100, zero:0,unit:"%", farbwert:"rgba(200,100,200,0.9)",
			  grad:[ 	
				  	{ info:"Sauerstoffsättigung mit Device" },
				]	
			 },
		 { id: "bloodglucose", title:"Blutzucker", sub:"Logo", kategorie:"Device", min:90.0, max:100, zero:0,unit:"%", farbwert:"rgba(200,100,200,0.9)",
			 grad:[ 	
